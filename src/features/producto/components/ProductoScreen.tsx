...
export default function ProductoScreen() {
	...
	if (isError) {
		return (
			<div className="p-8 text-red-600">Error al cargar los productos.</div>
		)
	}
	...
	return (
		<div className="p-8">
			...
			>
				{mostrarFormMarca
					? 'Ocultar Formulario de Marca'
					: 'Mostrar Formulario de Marca'}
			</button>
			...
			>
				{mostrarFormLinea
					? 'Ocultar Formulario de Línea'
					: 'Mostrar Formulario de Línea'}
			</button>
						...
						<tbody className="bg-white divide-y divide-gray-200">
							{products.map((product) => (
								<tr key={product.nombre + product.marca}>
									{' '}
									{/* Usar un identificador único real si existe */}
